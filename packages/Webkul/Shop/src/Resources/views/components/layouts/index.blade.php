...
>
    <head>
        ...
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-QQNB40PWWY"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'G-QQNB40PWWY');
        </script>
        ...
        <link rel="icon" type="image/x-icon" href="{{ core()->getCurrentChannel()->favicon_url ?? asset('favicon.ico') }}" />
    ...
    <body>
        ...
        <div id="app">
            ...
            <main id="main" class="relative z-0 bg-white">
                {{ $slot }}
            </main>
