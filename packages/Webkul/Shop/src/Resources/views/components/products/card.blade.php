...
@pushOnce('scripts')
    ...
    >
        ...
        >
            ...
            <div class="-mt-9 grid max-w-[291px] translate-y-9 content-start gap-2.5 bg-white p-2.5 transition-transform duration-300 ease-out group-hover:-translate-y-0 group-hover:rounded-t-lg max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-2 max-md:px-2.5 max-md:py-3 max-sm:min-w-[170px] max-sm:max-w-[192px]">
                ...
                <div class="action-items flex flex-col gap-2 opacity-100 transition-all duration-300 ease-in-out">
                    <!-- WhatsApp Order Button -->
                    <a
                        :href="'https://wa.me/254795020334?text=' + encodeURIComponent('Hi! I would like to order: ' + product.name)"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="flex w-full items-center justify-center gap-2 rounded-lg bg-[#25d366] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#1ebe5c] max-sm:py-2 max-sm:text-xs"
                    >
